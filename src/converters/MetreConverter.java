...
public class MetreConverter implements IConverterMaster {
    ...
    /**
     * @param value
     * @return double responsavel por tranformar a variavel do padrao internacional
     *         para um especifico
     */
    ...
    public String toString() {
        String textComboBox = String.format("metre (m) [%s]: %s", MeasureType.DISTANCE.getTypeString(),
